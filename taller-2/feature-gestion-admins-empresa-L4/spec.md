...
| **AC-2.4** (Bloquear edición de email) | **Dado** que existe un administrador, **cuando** se envía `PUT` incluyendo el campo `email`, **entonces** el sistema ignora ese campo, sin modificar el email existente. |
